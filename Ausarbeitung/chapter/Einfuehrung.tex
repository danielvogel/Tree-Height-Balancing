...
Diese Definition hilft im \ac{THB}, resultierende Bäume zu bewerten. Ist ein Baum nach Anwendung des \ac{THB} in Form eines HBT, ist die Optimierung des Verfahrens bestmöglich durchgeführt worden.
